 ...
 */
package com.example.protobuf.example6;
...
public class Example6Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Employee.Address address = Employee.Address.newBuilder()
                .setCity("Bengaluru")
        ...
        try (FileOutputStream outputStream = new FileOutputStream("example6file");) {
        ...
        try (FileInputStream inputStream = new FileInputStream("example6file")) {
